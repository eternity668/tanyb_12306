    ...
    jQuery.extend({
        ...
        loginClick: function () {
            $('#loginSub') .on('click', function (m) {
                ...
                var e = typeof (n) === 'boolean' ? $.verifyLoginPassword(k)  : n;
                if ('Y' == openRandCodeCheck && !verifyRandCode($('#randCode') [0], e)) {
                    return
                }
                var l = dhtmlx.modalbox({
                    targSrc: '<div style="z-index: 20000; position: fixed; left: 750.5px; top: 237px;"><img src="' + ctx + 'resources/images/loading.gif"></img></div>'
                });
        ...
        forgetMyPassword: function () {
            $('#forget_password_id') .on('click', function (a) {
