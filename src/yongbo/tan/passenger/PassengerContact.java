 ...
 * All Rights Reserved
 *
 * @Package yongbo.tan.util
 * @Title: Contact.java
 * @author yongbo.tan
 * @date 2014年12月24日 下午8:33:25
 */
public class PassengerContact implements Serializable
{
 ...
 // 必须有
	...
	public void setFirst_letter(String firstLetter) {
	...
	public void setTotal_times(String totalTimes) {
